...
if (esm.Card !== esmCard.Card || esm.ThemeProvider !== esmTheme.ThemeProvider || esm.Table !== esmTable.Table) {
...
if (cjs.Card !== cjsCard.Card || cjs.ThemeProvider !== cjsTheme.ThemeProvider || cjs.Table !== cjsTable.Table) {
