...
if (esm.Alert !== esmAlert.Alert || esm.Card !== esmCard.Card || esm.ThemeProvider !== esmTheme.ThemeProvider || esm.Table !== esmTable.Table) {
...
if (cjs.Alert !== cjsAlert.Alert || cjs.Card !== cjsCard.Card || cjs.ThemeProvider !== cjsTheme.ThemeProvider || cjs.Table !== cjsTable.Table) {
